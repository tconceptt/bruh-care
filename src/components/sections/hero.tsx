  ...
  return (
    <div id="hero" className="relative overflow-hidden rounded-[28px] bg-transparent">
      <div className="absolute inset-0 -z-10 rounded-[28px] bg-white/95 shadow-[0_18px_56px_rgba(26,67,56,0.08)] backdrop-blur">
        <Parallax speed={0.3} className="pointer-events-none absolute inset-x-4 top-[-36%] h-[320px] rounded-[999px] bg-[radial-gradient(circle_at_top,_rgba(254,190,41,0.22),_transparent_70%)] sm:inset-x-8 sm:h-[420px]">
          <div />
        </Parallax>
      </div>
      <div className="relative flex flex-col gap-6 p-6 sm:gap-8 sm:p-8 lg:grid lg:grid-cols-[minmax(0,1fr)_340px] lg:items-start lg:gap-8 lg:p-10 xl:p-12">
        <div className="flex flex-col gap-6 sm:gap-8 mb-8 sm:mb-0">
      
          <HeroReveal className="space-y-4 text-balance sm:space-y-6" delay={60} direction="up">
          ...
          <Reveal className="rounded-[26px] bg-[rgba(77,190,158,0.12)] p-6 shadow-[0_18px_48px_rgba(26,67,56,0.08)] ring-1 ring-[rgba(77,190,158,0.16)] sm:p-8" delay={160}>
            <StaggerReveal className="grid gap-6 sm:grid-cols-2 sm:gap-8" staggerDelay={120} direction="up">
              {stats.map((stat) => (
        ...
        <HeroReveal
          ...
          delay={350}
        >
          <FloatingAnimation intensity={0.8} speed={1.5}>
            <Image
              src="/bruh-logo.svg"
              alt="BRUH symbol"
              width={120}
          ...
          <StaggerReveal className="space-y-4 sm:space-y-6" staggerDelay={100} direction="left">
            <div>
          ...
          <HeroReveal delay={600} direction="scale">
