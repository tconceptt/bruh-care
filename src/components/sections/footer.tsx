...
export const Footer = () => {
  return (
    <Reveal
      as="footer"
      className="flex flex-col gap-4 border-t border-[rgba(26,67,56,0.08)] pt-6 text-base text-[var(--text-muted)] sm:pt-8"
    >
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between lg:gap-8">
        ...
        <div className="grid gap-4 text-sm font-semibold uppercase tracking-[0.28em] text-[var(--color-deep)] sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
