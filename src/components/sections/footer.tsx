...
export const Footer = () => {
  return (
    <Reveal
      as="footer"
      className="flex flex-col gap-4 border-t border-[rgba(26,67,56,0.08)] pt-6 text-sm text-[var(--text-muted)] sm:pt-8"
    >
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between lg:gap-8">
        <div className="max-w-sm space-y-3">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="text-xs font-semibold uppercase tracking-[0.3em] text-[var(--color-deep)] sm:text-sm">
              BRUH Care
            </span>
          </div>
        ...
        <div className="grid gap-4 text-xs font-semibold uppercase tracking-[0.28em] text-[var(--color-deep)] sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
